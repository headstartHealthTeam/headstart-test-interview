...
export class InterviewController {
  ...
  async submitResponse(
    ...
    return await this.interviewService.submitResponse(candidateId, submitResponseDto);
  }

  @Get('results/:candidateId')
  async getCandidateResults(@Param('candidateId', ParseIntPipe) candidateId: number) {
